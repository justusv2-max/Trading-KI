...
SHARED_DAILY = deque([81.996, 77.371, 76.387, 76.782, 77.687, 74.853, 73.816, 70.578, 72.151, 70.954, 71.022, 70.625, 68.608, 68.951, 69.243, 69.002, 72.554, 74.947, 72.13, 71.773, 78.131, 80.054, 80.386, 79.689, 82.492], maxlen=30)
...
if cache:
    ...
    if "shared_daily" in cache: SHARED_DAILY = deque(cache["shared_daily"], maxlen=30)
else:
